...
cout<<"\nEnter any option\n"<<endl
    <<"Enter (1) to find length of string"<<endl
    <<"Enter (2) to move string 1 to string 2"<<endl
    <<"Enter (3) to move string 2 to string 1"<<endl
    <<"Enter (4) to copy string 1 to string 2"<<endl
    <<"Enter (5) to copy string 2 to string 1"<<endl
    <<"Enter (6) to reverse string"<<endl
    <<"Enter (7) to compare length of strings"<<endl
    <<"Enter (8) to find substring in string"<<endl;
cin>>choice;
